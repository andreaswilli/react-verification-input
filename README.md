...
| classNames     | Object   | `{}`           | Object with CSS class names to add to the specified elements. Supported elements (= object-keys) are `container`, `character`, `characterInactive`, `characterSelected`, `characterFilled`, `seperator`                                                                                                                               |
| seperator       | string   | `'-'`          | Text to use for seperators between characters.
| seperatorIndices | number[] | `[]`         | Zero-based indices where seperators should be placed. [2] will place a seperator between the 3rd and 4th character.

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_proptypes__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_proptypes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_proptypes__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constants__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__styles_scss__ = __webpack_require__(5);
...
class VerificationInput extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
  ...
  handleKeyUp(event) {
    ...
    if (keyCode === __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* KEY_CODE */].ARROW_LEFT) {
      this.moveSelectionBy(-1);
      return;
    }

    if (keyCode === __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* KEY_CODE */].ARROW_RIGHT) {
    ...
    if (keyCode === __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* KEY_CODE */].BACKSPACE) {
    ...
    if (keyCode === __WEBPACK_IMPORTED_MODULE_3__constants__["a" /* KEY_CODE */].DELETE) {
      selectedIndex = this.state.selectedIndex;
      ...
      tan = `${this.state.tan.substring(0, selectedIndex)}${this.state.tan.substring(selectedIndex + 1) ? `${this.props.placeholder}${this.state.tan.substring(selectedIndex + 1)}` : ''}`;
      this.handleChange(tan, selectedIndex);
      return;
    }
  ...
  render() {
    ...
    const {
      className: characterClassName
          ...
          characterProps = _objectWithoutProperties(character, ['className']);

    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      _extends({
        className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()('verification-input__container', containerClassName)
      }, containerProps),
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        _extends({
          className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()('verification-input__characters', charactersClassName),
          onClick: () => this.input.focus()
        }, charactersProps),
        [...Array(length)].map((_, i) => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          _extends({
            className: __WEBPACK_IMPORTED_MODULE_1_classnames___default()('verification-input__character', characterClassName, {
...
VerificationInput.propTypes = {
  ...
  container: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.shape({
    className: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.string
  }),
  inputField: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.shape({
    className: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.string
  }),
  characters: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.shape({
    className: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.string
  }),
  character: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.shape({
    className: __WEBPACK_IMPORTED_MODULE_2_proptypes___default.a.string
  })
};
